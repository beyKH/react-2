function MovieCard({title, smallPoster, year, imdbRating, trailer}){

  return (
    <li className="search-results__item movie col-sm-6 mb-4">
      <div className="card">
        <img className="movie__poster card-img-top" src={smallPoster} alt="" width="300" height="200" />

        <div className="card-body">
          <h3 className="movie__title h5">Title {title}</h3>
          <p className="card-text">
            <span className="movie__year">YEar {year}</span>
          </p>

          <p className="card-text">
            <span className="movie__rating">Rating {imdbRating}</span>
          </p>
